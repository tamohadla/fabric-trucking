...
export function initDuplicateModal() {
  ...
  const f = {
    ...
    rawmaterial: document.getElementById("dup_rawmaterial"),    qtykg: document.getElementById("dup_qtykg"),
  ...
  async function save() {
    ...
    const payload = {
      ...
      rawmaterial: f.rawmaterial.value || "",      qtykg: f.qtykg.value ? Number(f.qtykg.value) : null,
      date: f.date.value || "",
